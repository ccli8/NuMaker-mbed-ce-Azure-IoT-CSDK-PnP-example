 ...
 *        (DPS)
 */
#define AZIOT_CONF_HSM_TYPE                     HSM_TYPE_SYMM_KEY

/**
 * @brief Registration ID when HSM_TYPE_SYMM_KEY is supported; Ignored
 *        for other HSM types (DPS)
 */
#define AZIOT_CONF_PROVISION_REGISTRATION_ID    "<REGISTRATION_ID>"

/**
 * @brief Symmetric key when HSM_TYPE_SYMM_KEY is supported; Ignored for
 *        other HSM types (DPS-only)
 */
#define AZIOT_CONF_PROVISION_SYMMETRIC_KEY      "<SYMMETRIC_KEY>"

/**
 * @brief Device provisioning service URI (DPS)
 */
#define AZIOT_CONF_PROVISION_ENDPOINT           "global.azure-devices-provisioning.net"

/**
 * @brief Device provisioning service ID scope (DPS)
 */
#define AZIOT_CONF_PROVISION_ID_SCOPE           "<ID_SCOPE>"

/**
 * @brief Device connection string for IoT Hub authentication (non-DPS)
 */
#define AZIOT_CONF_DEVICE_CONNECTION_STRING     "<DEVICE_CONNECTION_STRING>"
